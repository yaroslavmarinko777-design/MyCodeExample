...
namespace MyGame
{
    public partial class Form1 : Form
    {
        ...
        {      // Startet das Ziehen des Fensters
            dragging = true;
            pos.X = e.X;
            pos.Y = e.Y;
        }
        ...
        {        // Bewegt die Hintergründe, Gegner und Münzen nach unten und überprüft Kollisionen
            int speed = 4;
            bg1.Top += speed;  // Hintergrund bewegen
            bg2.Top += speed;

            int carSpeed = 6;
            enemy1.Top += carSpeed;
            enemy2.Top += carSpeed;  //Gegner bewegen

            coin.Top += speed;   // Münze bewegen
        ...
        {
            if (lose) return;
               // Bewegt das Auto nach links oder rechts, abhängig von den gedrückten Tasten
            int speed = 10;
        ...
        {   // Setzt das Spiel zurück, damit der Spieler erneut spielen kann
            enemy1.Top = -130;
            enemy2.Top = -400;
            labelLose.Visible = false;
            btnRestart.Visible = false;
